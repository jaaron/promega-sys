...
M564 H1 ; Enables Homing Requirement For Motor Activation
...
; G31 P450 X25 Y30 Z1.4 ; Set Z probe (IR) trigger value and offset
G31 P999 X-52 Y30 Z1.1 ; Set Z probe (limit switch) trigger value, offset
...
M208 X375 Y385 Z377 S0 ; Set axis maxima
